...
public class CollectLogPageQueryResult<T> extends PageQueryResult
{
  private int recordCount;

  @SuppressWarnings("unchecked")
public CollectLogPageQueryResult(int pageSize, int currentPage, int pageCount, List<T> datas)
  {
    super(pageSize, currentPage, pageCount, datas);
  }

  public CollectLogPageQueryResult(int pageSize, int currentPage, int pageCount, int recordCount, List<T> datas)
  {
  ...
  public String getPageInfo()
  {
    ...
    sb.append(this.recordCount + "条</span>");
